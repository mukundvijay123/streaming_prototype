...
from clientUtils import subscribe,continuous_consumer
...
if __name__ == "__main__":
    ...
    continuous_consumer(shm.name,lock,write_index,read_index,)
    ...
    # subscribe(RemoteAddress, FlightServerAddress)
